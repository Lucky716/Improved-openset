...
source_name = "amazon"
target_name = "webcam"
source_path = "/home/fujiahui/Desktop/openset_caffe/office-31/A_source/images"
target_path_train = "/home/fujiahui/Desktop/openset_caffe/office-31/W_target/images"  #分一下训练集和测试集
target_path_test = "/home/fujiahui/Desktop/openset_caffe/office-31/W_target/images"
"""
...
if __name__ == '__main__':
    ...
    fig = plt.figure()
    plt.plot(x, correct1, color='green', label='W-D True acc')
    plt.plot(x, correct2 , color='red', label='W-D OS(11)')
    plt.plot(x, correct3, color='blue', label='W-D OS*(10)')
    plt.plot(x, acc10, color='yellow', label='W-D acc10')
    plt.legend()  # 显示图例
    plt.show()
